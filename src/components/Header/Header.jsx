...
const Header = () => {
return (
    <header className="bg-[#0C1440] flex justify-between items-center px-12 py-2.5 absolute top-0 left-0 w-full">
        ...
        <div className="right flex gap-3 md:gap-8">
            <div className="svg-container cursor-pointer">
                <svg
                    className="call-svg w-6.25 h-6.25 fill-none stroke-white"
                    viewBox="0 0 24 24"
