		...
		<>
			...
			<div className="flex items-center justify-center mt-6 sm:mt-8 mx-10">
				<h2 className="text-center text-xl sm:text-2xl mb-25">
					Disfruta de vistas espectaculares al mar, habitaciones de
					lujo y servicios exclusivos en un ambiente relajado y
					sofisticado. Vive una experiencia única donde el sonido de
					las olas y la comodidad se encuentran. ¡Tu escape perfecto
					comienza aquí!
				</h2>
			</div>
		</>
